...
from data.dataset.dota2 import NAMES
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Distributed evaluation for DOTA2 dataset...')
