...
from data.dataset import DOTA2
...
def main():
    dir_weight = os.path.join(dir_save, 'dota2_weight')
    dir_log = os.path.join(dir_save, 'dota2_log')
    ...
    lr_cfg = [[0.6 * max_step, lr], [0.9 * max_step, lr / 10], [max_step, lr / 50]]
    ...
    dataset = DOTA2(data_dir, ['train', 'val'], aug)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Training for DOTA2 dataset...')
