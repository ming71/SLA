...
from data.dataset.hrsc2016 import NAMES
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Distributed evaluation for HRSC2016 dataset...')
    ...
    APs = get_det_aps(res, gts, num_classes, iou_thresh=0.5, use_07_metric=args.use_voc07)
    mAP = sum(APs) / len(APs)
    print('AP')
