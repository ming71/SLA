...
def main(rank, world_size):
    ...
    lr_cfg = [[0.7 * max_step, lr], [0.9 * max_step, lr / 10], [max_step, lr / 20]]
    ...
    loader = DataLoader(dataset, batch_sampler=batch_sampler, \
            num_workers=int(hyps['num_workers']), pin_memory=True, collate_fn=dataset.collate)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='distributed training for HRSC2016 dataset...')
