...
def main():
    dir_weight = os.path.join(dir_save, 'dota_weight')
    dir_log = os.path.join(dir_save, 'dota_log')
    ...
    dataset = DOTA(data_dir, ['train', 'val'], aug)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Training for DOTA dataset...')
